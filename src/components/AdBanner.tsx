...
import { resolveBannerUnitId, PROD_BANNER_UNIT_ID } from '../ads/adConfig';
import { getAdsModule } from '../ads/mobileAds';
 ...
 *
 * - __DEV__면 테스트 광고 단위, 프로덕션이면 실제 ID (없으면 렌더 안 함)
...
export function AdBanner() {
  ...
  const unitId = useMemo(
    () => resolveBannerUnitId({ isDev: __DEV__, prodId: PROD_BANNER_UNIT_ID }),
    [],
  );
